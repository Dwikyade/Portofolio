...
const TIMELINE = [
  { year: "2023", title: "Started University", desc: "Enrolled in Information Systems" },
  { year: "2024", title: "First Web Project", desc: "Built PHP Native web applications" },
  { year: "2025", title: "Expanded Stack", desc: "Laravel, CodeIgniter 4 & Flutter" },
  { year: "2026", title: "Modern Frontend", desc: "React, Next.js & TypeScript" },
];
          ...
          <div>
            ...
            <div className="about-bio-block">
              <p className="about-fade text-base lg:text-lg text-zinc-700 dark:text-zinc-300 leading-relaxed mb-10 opacity-0">
                I&apos;m Dwiky an Information Systems student and full-stack
            ...
            <div className="timeline-block">
              ...
              <div className="space-y-0">
                {TIMELINE.map((item, i) => (
                  <div
                    key={i}
                    className="timeline-item flex gap-5 opacity-0"
                  >
                    {/* Line + dot */}
